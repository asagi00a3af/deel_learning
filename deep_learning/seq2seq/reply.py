...
def main():
    ...
    parser.add_argument('--model', '-m', type=str, default='models/seq2seq_conversation_e100_l3_u256_model.npz')
    ...
    # モデル準備
    print("#Start test")
    talker = Talker(vocab_path=args.vocab, model_path=args.model)
